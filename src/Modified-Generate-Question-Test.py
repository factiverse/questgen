...
def eval(
    ...
    examples = raw_dataset["test"]
    list_examples = []
    for z in range(len(examples)):
        pred = predict(examples[z]["input_text"], model, tokenizer, 3)
        ...
        # examples[z]["pred"] = pred
        list_examples.append(examples[z])
        list_examples[-1]["pred"] = pred
        # preds.append(
        #     {"pred": pred,
        #      "label": target,
        #      "input": inp,
